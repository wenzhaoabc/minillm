...
from minillm.dataset.lm_dataset import DPODataset
...
def train_epoch(
    ...
    for step, batch in enumerate(loader, start=start_step + 1):
        # x 与 y 错位1， 以 next_token 预测的形式计算损失
...
if __name__ == "__main__":
    ...
    wandb_run_name = (
        args.run_name
        or f"MiniLLM-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
    )
    ...
    save_run_metadata(
        ...
        lm_config,
        args,
        extra={"stage": "dpo", "beta": args.beta},
        wandb=wandb,
    )
