...
from trainer.configs import GRPOConfigArgs, parse_config_groups, namespace_from_configs
...
if __name__ == "__main__":
    ...
    args = namespace_from_configs(model_args, train_args, script_args, grpo_args)
    ...
    # ========== 4. 配wandb ==========
    wandb_run_name = args.run_name or f"MiniLLM-GRPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
    wandb = init_wandb_run(args, ckp_data, wandb_run_name, lm_config)
    save_run_metadata(args.output_dir, lm_config, args, extra={"stage": "grpo"}, wandb=wandb)
