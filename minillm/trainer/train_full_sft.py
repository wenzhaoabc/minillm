...
if __name__ == "__main__":
    ...
    # ========== 4. 配wandb ==========
    wandb_run_name = f"MiniLLM-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
    wandb = init_wandb_run(args, ckp_data, wandb_run_name, lm_config)
    save_run_metadata(args.save_dir, lm_config, args, extra={"stage": "full_sft"}, wandb=wandb)
